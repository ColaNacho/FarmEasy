...
<body>
	...
	<nav class="navbar">
		...
		<ul class="navbar-menu">
			...
			<li class="depth1"><a href="bigData.do?products_name=설향">농산물 빅데이터</a></li>
			<li class="depth1"><a href="d_board">게시판</a>
				<ul class="submenu">
					<li><a href="/FarmEasy/boardList2.do">게시판</a></li>
		...
		<c:when test="${mvo.m_id eq null}">
			...
			<c:otherwise>
				...
				<li><a href="f_myPage">${mvo.m_id} 님</a></li>
			</c:otherwise>
		</c:choose> 
		</ul>
		<a href="#" class="navbar-more"> <i class='fa fa-bars'	style='color: white; margin-top: 14px;'></i>
		</a>
	</nav>
	
	<div id="sub-title">답변 쓰기</div>

	<div class="wd-basic-960 mb-auto mt-4" id="info-bottom"
		style="height: 650px;">
		<form name="FEForm1" method="post" action="replyInsert">
