...
<!-- encType="multipart/form-data" -->
	<div class="wd-basic-960 mb-auto mt-4" id="info-bottom"	style="height: 650px;">
			...
			<table>
				<tr>
					...
					<td>
						<div>
							<span>
								<input type="text" title="제목" maxlength="1900" name="board_title" value="${content_view.board_title}" required>
							</span>
						</div>
					</td>
				</tr>
				...
				<tr>
					<th>내용</th>
					<td>
						<textarea name="board_content" id="nttCn" class="textarea100" title="내용" wrap="hard">${content_view.board_content}</textarea>
					</td>
				</tr>
	<!-- 			<tr>
					<th>첨부파일</th>
			...
			<div id="board_write">
				<input type="hidden" name="board_id" value='<c:out value="${content_view.board_id}" />' />
